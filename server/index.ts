...
<html lang="en">
  ...
  // SPA can poll agent events from iframes where Threads session cookies aren't available.
  // Agent routes have their own checkAuth() for per-document access control.
